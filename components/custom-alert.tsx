...
import { ChevronRight, Info, AlertCircle, BookOpen, Download, Smartphone } from "lucide-react"
...
export function CustomAlert({
  ...
  return (
    <>
      <Button variant={variant} size={size} className={className} onClick={() => setIsOpen(true)} {...props}>
        {buttonText}
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogAction asChild>
              <Button variant={actionButtonVariant}>{actionButtonText}</Button>
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
