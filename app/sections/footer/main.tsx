                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-3">
                    <div className="space-y-4">
                        ...
                        <p className="text-green-100 max-w-xs">
                            Conectando estudantes com deficiência física a
                            escolas verdadeiramente acessíveis.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col space-y-2 text-green-100">
                            <div className="flex items-start">
                                ...
                                <span>
                                    ETEC Abdias do Nascimento S/N - São Paulo,
                                    SP
                                </span>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <Link
                                    href="https://www.instagram.com/educaavalia/"
                                    target="_blank"
                            ...
                            <div className="flex items-start">
                                ...
                                <Link
                                    href="https://www.linkedin.com/company/educaavalia"
                                    target="_blank"
                                    className="hover:text-green-300 transition-colors"
                                >
                                    EducaAvalia
