            ...
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                    ...
                    <p className="max-w-[700px] text-gray-600 md:text-xl/relaxed">
                        Nosso aplicativo oferece diversas vantagens para
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">
                                Aplicativo desenvolvido com uma interface
                                intuitiva e amigável, incorporando tecnologias
                                de acessibilidade.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">
                                Leia experiências de outros estudantes e
                                famílias com necessidades semelhantes.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">
                                Busque escolas com base nas necessidades
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">
                                Conecte-se com outras famílias e compartilhe
