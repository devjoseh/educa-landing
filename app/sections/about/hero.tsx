                ...
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                    <div className="space-y-4">
                        ...
                        <p className="max-w-[600px] text-gray-600 md:text-xl">
                            Conectamos estudantes com deficiência física a
                            escolas verdadeiramente acessíveis, promovendo
                            educação inclusiva e oportunidades iguais para
                            todos.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link href="https://www.instagram.com/educaavalia/" target="_blank">
